   ...
   float [][]CPQ = new float[27][12];
    ...
    void Excluir(){
        switch(ExcluirItem){
            ...
            case 106:
                if(CPQ[5][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[5][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[5][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[5][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[5][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            
            case 107:
                if(CPQ[6][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[6][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[6][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[6][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[6][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
                case 108:
                    if(CPQ[7][(MesaEscolhida + 2)] > 1){
                        System.out.println("---------------------------------------------------------------\n");  
                        System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[7][0]);
                        QuantExc = leitor.nextInt();
                            if(QuantExc > CPQ[7][MesaEscolhida + 2]){
                                System.out.print("Valor Inválido");
                                VerificarMesa();                         
                            }
                        CPQ[7][(MesaEscolhida + 2)] -= QuantExc;
                        PedidoMesa();   
                    }
                    CPQ[7][(MesaEscolhida + 2)] -= 1;
                    PedidoMesa();
                    break;
            
            case 109:
                if(CPQ[8][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[8][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[6][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[8][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[8][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 110:
                if(CPQ[9][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[9][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[9][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[9][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[9][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;   
            
            case 201:
                if(CPQ[10][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[10][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[10][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[10][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[10][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 202:
                if(CPQ[11][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[11][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[11][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[11][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[11][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 203:
                if(CPQ[12][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[12][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[12][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[12][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[12][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 204:
                if(CPQ[13][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[13][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[13][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[13][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[13][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 205:
                if(CPQ[14][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[14][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[14][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[14][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[14][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;

            case 206:
                if(CPQ[15][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[15][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[15][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[15][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[15][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 207:
                if(CPQ[16][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[16][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[16][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[16][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[16][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 301:
                if(CPQ[17][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[17][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[17][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[17][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[17][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 302:
                if(CPQ[18][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[18][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[18][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[18][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[18][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;   

            case 303:
                if(CPQ[19][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[19][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[19][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[19][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[19][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;  

            case 401:
                if(CPQ[20][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[20][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[20][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[20][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[20][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break; 
            
            case 402:
                if(CPQ[21][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[21][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[21][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[21][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[21][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 403:
                if(CPQ[22][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[22][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[22][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[22][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[22][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 404:
                if(CPQ[23][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[23][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[23][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[23][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[23][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;  
            
            case 405:
                if(CPQ[24][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[24][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[24][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[24][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[24][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
            
            case 406:
                if(CPQ[25][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[25][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[25][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();                         
                        }
                    CPQ[25][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();   
                }
                CPQ[25][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;

            case 407:
                if(CPQ[26][(MesaEscolhida + 2)] > 1){
                    System.out.println("---------------------------------------------------------------\n");  
                    System.out.printf("Quantos pedidos de %s deseja cancelar? ->", nomes[26][0]);
                    QuantExc = leitor.nextInt();
                        if(QuantExc > CPQ[26][MesaEscolhida + 2]){
                            System.out.print("Valor Inválido");
                            VerificarMesa();
                            
                        }
                    CPQ[26][(MesaEscolhida + 2)] -= QuantExc;
                    PedidoMesa();
                } 
                CPQ[26][(MesaEscolhida + 2)] -= 1;
                PedidoMesa();
                break;
